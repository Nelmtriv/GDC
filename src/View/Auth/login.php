...
<body>
    <div class="login-box">
        ...
        <form method="POST" action="../../Controller/Auth/loginAuth.php">
            ...
            <button type="button" onclick="window.location.href='register.php';" class="login-btn">
                <i class="fas fa-sign-un-alt"></i> Registrar
            </button>
        </form>
